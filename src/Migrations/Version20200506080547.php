 ...
 */
final class Version20200506080547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE number number VARCHAR(255) NOT NULL, CHANGE status status INT DEFAULT NULL, CHANGE payment_token payment_token VARCHAR(255) DEFAULT NULL, CHANGE tracking_number tracking_number VARCHAR(255) DEFAULT NULL');
