 ...
 */
final class Version20200424085641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE firstname firstname VARCHAR(50) DEFAULT NULL, CHANGE lastname lastname VARCHAR(50) DEFAULT NULL, CHANGE avatar avatar VARCHAR(255) DEFAULT NULL, CHANGE loyalty loyalty INT DEFAULT NULL, CHANGE role roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
